#looks at hatchling proportion (relative to adults) as a function of proportion Peaks of Otter
#salamanders at a site
#includes site as a random effect (since PO prop is measured at this level) 
#plus pass/date as nested random effects
#so model is stagebin ~ propPO + (1|site) + (1|pass/date)
...
#proportion of slope values less than zero (reduced hatchlings away from allopatric sites)
mean(post$'b[2]'<0)
