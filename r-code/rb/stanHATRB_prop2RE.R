#Redback hatchlings (relative to adults) as a function of the proportion of Peaks of Otter
...
int<lower=0,upper=1> y[N];  //stage variable (1/0)
int<lower=0> n_site; 
...
#proportion of posterior with negative slope (reduced hatchlings with higher propPO)
mean(post$'b[2]'<0)
