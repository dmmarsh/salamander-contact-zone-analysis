#model for body condition of Redback salamanders as a function of site type
#includes site type as a fixed effect (category) and pass/date as nested random effects
...
#proportion of the posterior that's negative (i.e. reduced body condition in the contact zone)
mean(post$'b[2]'<0)
mean(post$'b[3]'<0)
mean(post$'b[4]'<0)
